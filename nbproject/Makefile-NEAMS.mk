...
${OBJECTDIR}/source/MaterialEnum.o: source/MaterialEnum.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -DNEAMS -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/MaterialEnum.o source/MaterialEnum.cpp
...
${OBJECTDIR}/source/RadialMesh.o: source/RadialMesh.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -DNEAMS -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/RadialMesh.o source/RadialMesh.cpp
