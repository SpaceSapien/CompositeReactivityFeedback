...
${OBJECTDIR}/source/CylindricalMesh.o: source/CylindricalMesh.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -DNEAMS -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/CylindricalMesh.o source/CylindricalMesh.cpp

${OBJECTDIR}/source/CylindricalMicroCell.o: source/CylindricalMicroCell.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -DNEAMS -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/CylindricalMicroCell.o source/CylindricalMicroCell.cpp
...
${OBJECTDIR}/source/FuelPinMonteCarlo.o: source/FuelPinMonteCarlo.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -DNEAMS -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/FuelPinMonteCarlo.o source/FuelPinMonteCarlo.cpp
